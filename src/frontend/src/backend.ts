...
function from_candid_variant_n7(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "gym" in value ? Category.gym : "men" in value ? Category.men : "watches" in value ? Category.watches : "other" in value ? Category.other : "women" in value ? Category.women : value;
}
